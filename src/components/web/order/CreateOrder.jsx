...
export default function CreateOrder() {
    ...
    const onSubmit = async users => {
        ...
        if (data.message == 'success') {
            toast.success('your order added successfuly ', {
                position: "top-center",
                autoClose: false,
    ...
    return (
        <div className='container'>
            ...
            <div className='px-5 bg-secondary text-white pb-5'>

                <h2 className='text-center py-5'>Create Order</h2>
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className="row py-3">
                        ...
                        <div className="coupon-form ">
                            ...
                            <input type="text" className='form-control' placeholder="Coupon Code" name='couponName' id='couponName' value={formik.values.couponName} onChange={formik.handleChange} onBlur={formik.handleBlur} />
                        </div>
                    </div>
                    <button type='submit' className='form-control bg-danger text-white' disabled={!formik.isValid} >Create</button>
                </form>
